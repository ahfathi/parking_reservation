function generate_slot(id) {
    return '<div class="slot" style="margin-left: 30px" id="' + id +'">Slot: <input size="10" type="text"/></div>';
}
function generate_segment(id) {
    return '<div class="segment" style="margin-left: 20px" id="' + id +'">Segment: <input size="10" type="text"/>' + generate_slot(0) + '</div>';
}
function generate_floor(id) {
    return '<div class="floor" style="margin-left: 10px" id="' + id +'">Floor: <input size="10" type="text"/>' + generate_segment(0) + '</div>';
}
